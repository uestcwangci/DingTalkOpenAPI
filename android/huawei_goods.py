...
class GoodsHelper:
    def __init__(self):
        ...
        capabilities = dict(
            ...
            deviceName='Android',
            appPackage='com.vmall.client',
            appActivity='.base.fragment.VmallWapActivity',
            resetKeyboard=True,
            noReset=True,
    ...
    def keep_watch(self, label: str, original_input: str):
        ...
        sleep(5)
        # 点击手机按钮
        wait_for_find(by=AppiumBy.ID, timeout=20, value="2-11477593").click()
        # 点击新品秀场
        wait_for_find(by=AppiumBy.ID, value="bottomNav-1-11426611").click()
        # 点击最大的广告
        wait_for_find(by=AppiumBy.ID, value="immersiveHeader-whole-11815410").click()
        # 点击立即购买
        wait_for_find(by=AppiumBy.ID, value="prd-botnav-rightbtn-txt").click()
